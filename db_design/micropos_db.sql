...
CREATE TABLE IF NOT EXISTS `transactions` (
  ...
  `status`         ENUM('Paid', 'Unpaid', 'Partial') NOT NULL DEFAULT 'Paid' COMMENT 'Unpaid = full debt; Partial = split payment',
...
CREATE TABLE IF NOT EXISTS `debts` (
  ...
  `mode_of_payment` ENUM('Cash', 'GCash', 'Other') NOT NULL DEFAULT 'Cash',
